...
module.exports = (sequelize, DataTypes) => {
  const OrderLense = sequelize.define(
    "OrderLense",
    {
  ...
  OrderLense.associate = function (models) {
    ...
    OrderLense.belongsTo(models.Lense, {
      as: "left",
      foreignKey: "id_lense_left",
    });
    OrderLense.belongsTo(models.Lense, {
      as: "right",
      foreignKey: "id_lense_right",
    });
    OrderLense.belongsTo(models.Doctors, {
      as: "customer",
